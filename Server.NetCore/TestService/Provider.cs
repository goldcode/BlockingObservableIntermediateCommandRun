...
namespace SiLAGen.TestService
{
    ...
    public partial class TestServiceProvider : IFeatureProvider
    {
        ...
        public void Register(IServerBuilder registration)
        {
            ...
            registration.RegisterCommandWithIntermediates<ObservableIntermediateCommandWithCancellationRequestDto, string, ObservableIntermediateCommandWithCancellationIntermediateDto>("ObservableIntermediateCommandWithCancellation", ObservableIntermediateCommandWithCancellation, ConvertObservableIntermediateCommandWithCancellationIntermediate, null);
        }
        ...
        private ObservableIntermediateCommandWithCancellationIntermediateDto ConvertObservableIntermediateCommandWithCancellationIntermediate(string intermediate)
        {
            return new ObservableIntermediateCommandWithCancellationIntermediateDto(intermediate, _server);
        }
        
        /// <summary>
        /// Executes the Observable Intermediate Command With Cancellation command
        /// </summary>
        /// <param name="request">A data transfer object that contains the command parameters</param>
        /// <returns>The command response wrapped in a data transfer object</returns>
        protected virtual Tecan.Sila2.IIntermediateObservableCommand<string> ObservableIntermediateCommandWithCancellation(ObservableIntermediateCommandWithCancellationRequestDto request)
        {
            request.Validate();
            return _implementation.ObservableIntermediateCommandWithCancellation();
        }
        ...
        public System.Reflection.MethodInfo GetCommand(string commandIdentifier)
        {
            ...
            if ((commandIdentifier == "sila/contracts/TestService/v1/Command/ObservableIntermediateCommandWithCancellati" +
                "on"))
            {
                return typeof(ITestService).GetMethod("ObservableIntermediateCommandWithCancellation");
            }
            return null;
        }
